...
| Remote module coverage | :test_tube: Partial | 18 modules verified against a live SSH target; the rest are refused remotely or listed as connection-only. See `FEATURE_STATUS.md`. |
...
| Module compatibility | Local: broad; remote: 18 verified modules | 95%+ |
